...
namespace Project1Fixed
{
    public class recognizer_GravestoneDoji : Recognizer
    {
        ...
        public override string usedPattern() { return "GraveStone Doji"; }
        /// <summary>
        ...
        /// Candlestick in the list of candlesticks to see if they match the IsGraveStoneDoji function. If they do then the index is added
        ...
        public override List<int> recognize(List<Candlestick> candlesticks)
        {
            ...
            {
                if (candle.IsGraveStoneDoji()) { result.Add(i); }
                i++;
            }
            return result;
        }
