...
{
    public class recognizer_WhiteMarubozu : Recognizer
    {
        //Defines the name of the recognizer
        public override string usedPattern() { return "White Marubozu"; }
        /// <summary>
        ...
        /// Candlestick in the list of candlesticks to see if they match the IsWhiteMarubozu function. If they do then the index is added
        ...
        public override List<int> recognize(List<Candlestick> candlesticks)
        {
            ...
            {
                if (candle.IsWhiteMarubozu()) { result.Add(i); }
                i++;
            }
            return result;
        }
