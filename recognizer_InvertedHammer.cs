...
namespace Project1Fixed
{
    public class recognizer_InvertedHammer : Recognizer
    {
        ...
        public override string usedPattern() { return "Inverted Hammer"; }
        /// <summary>
        ...
        /// Candlestick in the list of candlesticks to see if they match the IsInvertedHammer function. If they do then the index is added
        ...
        public override List<int> recognize(List<Candlestick> candlesticks)
        {
            ...
            {
                if (candle.IsInvertedHammer()) { result.Add(i); }
                i++;
            }
            return result;
        }
