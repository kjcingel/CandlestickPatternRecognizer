...
{
    public class recognizer_LongLeggedDoji : Recognizer
    {
        //Defines the name of the recognizer
        public override string usedPattern() { return "LongLegged Doji"; }
        /// <summary>
        ...
        /// Candlestick in the list of candlesticks to see if they match the IsLongLeggedDoji function. If they do then the index is added
        ...
        public override List<int> recognize(List<Candlestick> candlesticks)
        {
            ...
            {
                if (candle.IsLongLeggedDoji()) { result.Add(i); }
                i++;
            }
            return result;
        }
