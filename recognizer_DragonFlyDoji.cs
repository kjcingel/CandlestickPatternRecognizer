...
namespace Project1Fixed
{
    public class recognizer_DragonFlyDoji : Recognizer
    {
        ...
        public override string usedPattern() { return "DragonFly Doji"; }
        /// <summary>
        ...
        /// Candlestick in the list of candlesticks to see if they match the IsDragonFlyDoji function. If they do then the index is added
        ...
        public override List<int> recognize(List<Candlestick> candlesticks)
        {
            ...
            {
                if (candle.IsDragonFlyDoji()) { result.Add(i); }
                i++;
            }
            return result;
        }
