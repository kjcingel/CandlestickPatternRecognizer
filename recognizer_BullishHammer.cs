...
namespace Project1Fixed
{
    public class recognizer_BullishHammer : Recognizer
    {
        ...
        public override string usedPattern() { return "Bullish Hammer"; }
        /// <summary>
        ...
        /// Candlestick in the list of candlesticks to see if they match the IsBullishHammer function. If they do then the index is added
        ...
        public override List<int> recognize(List<Candlestick> candlesticks)
        {
            ...
            {
                if (candle.IsBullishHammer()) { result.Add(i); }
                i++;
            }
            return result;
        }
