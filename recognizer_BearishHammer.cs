...
namespace Project1Fixed
{
    public class recognizer_BearishHammer : Recognizer
    {
        ...
        public override string usedPattern() { return "Bearish Hamer"; }
        /// <summary>
        ...
        /// Candlestick in the list of candlesticks to see if they match the IsBearishHammer function. If they do then the index is added
        ...
        public override List<int> recognize(List<Candlestick> candlesticks)
        {
            ...
            {
                if (candle.IsBearishHammer()) { result.Add(i); }
                i++;
            }
            return result;
        }
